...
abstract class BaseViewModel<I, O : IMachineLearningOutputStats, FR : IOldMachineLearningFinalResult> (private var machineLearningRepository: IMachineLearningFactory<I, O, FR>): ViewModel(){
    // SHARED FLOWS
