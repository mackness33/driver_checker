...
abstract class BaseViewModel<I, O : IMachineLearningOutputStatsOld, FR : IMachineLearningFinalResult> (private var machineLearningRepository: IMachineLearningFactory<I, O, FR>): ViewModel(){
    // SHARED FLOWS
