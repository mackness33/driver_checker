...
abstract class BaseViewModel<I, O : IMachineLearningOutputStatsOld, FR : IMachineLearningFinalResultOld> (private var machineLearningRepository: IMachineLearningFactory<I, O, FR>): ViewModel(){
    // SHARED FLOWS
