...
class ImageDetectionLocalRepository (override val model: MLLocalModel<ImageDetectionInput, MLResult<ArrayList<ImageDetectionBox>>>?) : MLLocalRepository<ImageDetectionInput, MLResult<ArrayList<ImageDetectionBox>>> (model) {}