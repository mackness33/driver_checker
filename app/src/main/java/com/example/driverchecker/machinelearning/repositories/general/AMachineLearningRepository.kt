...
abstract class AMachineLearningRepository<I, O : IMachineLearningOutputStatsOld, FR: IMachineLearningFinalResult> (override val repositoryScope: CoroutineScope) :
