...
abstract class AMachineLearningRepository<I, O : IMachineLearningOutputMetrics, FR: IMachineLearningFinalResult> (override val repositoryScope: CoroutineScope) :
