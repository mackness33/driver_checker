...
//        protected set
//
//    protected open var availableWindows: Map<IWindowSettings, IMachineLearningWindow<E>> = emptyMap()
//    override var selectedWindows: Set<IMachineLearningWindow<E>> = emptySet()
//        protected set
//
//    init {
...
//
//        try {
//            val mAvailableWindows: MutableMap<IWindowSettings, IMachineLearningWindow<E>> = mutableMapOf()
...
//                        mAvailableWindows.putIfAbsent(
//                            WindowSettings(frames, threshold, type),
//                            BasicImageDetectionWindow(frames, threshold)
//                        )
//                    }
//                }
//            }
