...
abstract class MachineLearningRepository<Data, Prediction, Superclass, Result : MachineLearningArrayListOutput<Data, Prediction, Superclass>> () : MLRepositoryInterface<Data, Result> {
    ...
    protected var model: IMachineLearningModel<Data, Result>? = null
